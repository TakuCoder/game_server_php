...
$db = getDbInstance();
$select = array('id', 'player_name', 'current_score', 'high_score');

// Start building query according to input parameters
// If search string
if ($search_str) {
	$db->where('player_name', '%' . $search_str . '%', 'like');
	$db->orwhere('player_name', '%' . $search_str . '%', 'like');
}
...
$rows = $db->arraybuilder()->paginate('score_data', $page, $select);
    ...
    <div class="well text-center filter-form">
        <form class="form form-inline" action="">
            ...
            <select name="order_by" class="form-control">
                <?php
foreach ($costumers->setOrderingValuesScore() as $opt_value => $opt_name):
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['player_name'] . ' ' . $row['player_name']); ?></td>
                <td><?php echo htmlspecialchars($row['current_score']); ?></td>
