                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li<?php echo (CURRENT_PAGE == 'customers.php' || CURRENT_PAGE == 'add_customer.php') ? ' class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-user-circle fa-fw"></i> Game Data<i class="fa arrow"></i></a>
                                    <ul class="nav nav-second-level">
                                        <li><a href="playerData.php"><i class="fa fa-list fa-fw"></i> User Data</a></li>
                                        <li><a href="scoreData.php"><i class="fa fa-list fa-fw"></i> Score Data</a></li>
                                        <!-- <li><a href="add_customer.php"><i class="fa fa-list fa-fw"></i>Score Data</a></li> -->
                                    </ul>
                                </li>
